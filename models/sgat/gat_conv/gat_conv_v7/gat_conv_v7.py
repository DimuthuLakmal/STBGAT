...
from models.sgat.gat_conv.gat_conv_v7.message_passing_v7 import MessagePassingV7


class GATConvV7(MessagePassingV7):
    ...
    def edge_update(self, alpha_j: Tensor, alpha_i: OptTensor,
        ...
        # No edge attn calculation in this function
